...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en"> <!--We were directed to validate using XHTML1.1, so I am using the headers from Labs 1 & 2-->
    ...
    <body class="overallContainer">
        ...
        <div class="center">
            <form id="SignUpForm" class="signContainer" action="signUp.php" method="post">
        ...
        <div class="bottom">
            <a href="https://validator.w3.org/check?uri=http://www.webdev.cs.uregina.ca/~ljc806/Assignments/Assign5/pages/signUp.php">Validate 'signUp.php'</a>
        </div>
