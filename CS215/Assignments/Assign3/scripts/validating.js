function emailValidation(email){
 ...
 function loginFormValidation(event){
    ...
    var user = elements[0].value;       //Username
 ...
 function ResetForm(event){
    ...
    if(msg_char.textContent.includes('Required')){
        resetMSG(msg_char, data[2].getAttribute("maxlength"));
        resetMSG(msg_charA1, data[3].getAttribute("maxlength"));
        resetMSG(msg_charA2, data[4].getAttribute("maxlength"));
        display_info.textContent = "";
    }
 }

 function resetMSG(msg_char, max){
 ...
 function characterFormValidation(event){
    ...
    var quesValid = characterValidation(question, "");
    var a1Valid = characterValidation(answer1, "A1");
    var a2Valid = characterValidation(answer2, "A2");
 ...
 function dateTimeValidation(open, close){
    ...
    if(openDate == null || openDate == ""){
        ...
        textNode = document.createTextNode("Incorrect format. Example: 2022/07/15, 08:45 a.m.");
        msg_openDate.appendChild(textNode);
        valid = false;
    }
