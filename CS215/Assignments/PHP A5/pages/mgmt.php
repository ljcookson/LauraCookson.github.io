<?php
    ...
    if(isset($_POST["mgmtVoteButton"]) && $_POST["mgmtVoteButton"]){
        //print_r($_POST);
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en"> <!--We were directed to validate using XHTML1.1, so I am using the headers from Labs 1 & 2-->
    ...
    <body class="overallContainer">
        ...
        <div class="center">
            <form class="mgmtContainer" method="POST" action="">
                <div class="mgmtPolls">
                    <?php
                        $i = 1;
                        ...
                        ?>
                        <input type="radio" name="polls" class="mgmtPollsRadio" id=<?=$row['poll_ID']?>/>
                ...
                <div class="mgmtPollsButtons">
                    ...
                    <div class="mgmtPollsButtonsMiddle">
                        <!-- <input type="hidden" name="mgmtextra_vote" id="mgmtextra_vote" value="<?=$row['poll_ID']?>" /> -->
                        <input type="submit" value="Vote" name="mgmtVoteButton"/>
                    </div>
