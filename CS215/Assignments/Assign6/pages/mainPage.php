<?php
    ...
    $recentPollQuery = "SELECT DISTINCT poll_ID, question, createdDate FROM Polls WHERE closeDate >= (SELECT CURRENT_TIMESTAMP) ORDER BY createdDate DESC, poll_ID DESC LIMIT 5";
    //print($recentQuery);
    ...
    <body class="overallContainer">
        ...
        <div class="center">
            <div class="mainContainer">
                <form class="mainActivePolls" id="homePage" method="get" action="vote.php">
                    ...
                    <div class="mainActivePollsButtons">
                        ...
                        <div class="mainActivePollsButtonsRight">
                            ...
                            <input type="submit" formaction="results.php" value="Results" name="mainResultButton"/>
                        </div>
                    </div>
                </form>
        ...
        <div class="bottom">
            <a href="https://validator.w3.org/check?uri=http://www.webdev.cs.uregina.ca/~ljc806/Assignments/Assign6/pages/mainPage.php">Validate 'mainPage.php'</a> | 
            <a href="https://validator.w3.org/check?uri=http://www.webdev.cs.uregina.ca/~ljc806/Assignments/Assign6/css/cookson.css">Validate 'cookson.css'</a>
        </div>
